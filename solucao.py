...
from sol_seir import plotting_seirs_plus_estado
from sol_seir import plotting_seirs_plus_municipio

def seir_hosp_estado():
    plotting_seirs_plus_estado()


def seir_hosp_municipio():
    plotting_seirs_plus_municipio()
